          ...
          <ul className='text-lg mt-2 dark:text-gray-900'>
			...
			<section className=" py-20">
				...
				<div className="grid grid-cols-2 md:grid-cols-3 gap-4">
					{apiBerita["data"]
						.filter(
							(res) => res.slug != response?.slug && res.id <= 4,
						)
						.map((res: propsBerita, idx: number) => (
							<div
							...
							>
								...
								<h1 className="mt-5 text-xl tracking-wide font-semibold">
									PT JBT Siapkan Rekayasa Lalu Lintas
									Antisipasi Kepadatan Kendaraan Selama Libur
									Nataru
								</h1>
								<div className="py-5">
									<Link
