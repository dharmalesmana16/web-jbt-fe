...
export default async function page({ searchParams }: any) {
	...
	const response = await apiSejarah["data"].find(
		...
		<div>
					...
					<div className="px-4  py-12 grid md:grid-cols-6">
						<div className="pb-2 max-w-2xl  col-span-4">
							<h1 className="text-main tracking-wide font-semibold text-xl md:text-4xl">
								Tentang Kami dalam Mewujudkan Konektivitas
								Terbaik di Bali
							</h1>
						</div>
						<div className=" w-full col-span-2">
							<p className="leading-normal text-gray-500 text-md ">
								Sebagai bagian dari Jasa Marga Group, kami
								menghadirkan solusi transportasi modern di Bali
								melalui Tol Bali Mandara. Dengan standar
								keselamatan tinggi dan infrastruktur
								berkualitas, kami berkomitmen memberikan
								pengalaman berkendara terbaik untuk Anda.{" "}
							</p>
						</div>
					</div>
				</div>
				...
				<div className="max-w-xl md:container mx-auto  ">
					<div className="text-center">
						<div className="   py-12 lg:py-12 ">
							<h1 className="text-main font-bold md:font-black text-xl tracking-normal py-2">
								Visi
							</h1>
							<hr className="w-16 md:w-24 text-second  mx-auto  border-t-8 md:border-t-12 " />
							<h1 className="text-main text-2xl md:text-5xl font-bold py-5">
								“Menjadi Perusahaan Pengelola jalan tol
			...
			<section className="container mx-auto w-full p-12 md:p-12 min-h-[100vh] bg-cover bg-no-repeat  bg-white shadow-t-xl  rounded-t-4xl">
				<div className="text-center mx-auto py-8">
					...
					<img
						src="/image/move.png"
						className="mx-auto rounded-t-[4rem] w-full h-[500px] md:h-[1000px] py-4"
					/>
				</div>
			</section>
			{/* Section Sejarah */}
			<section className="bg-center mx-auto w-full p-4 md:p-12 min-h-[100vh] bg-cover bg-no-repeat  bg-white shadow-t-xl  rounded-t-4xl">
				<div className="container mx-auto  ">
					<h1 className="font-black text-3xl text-main leading-9 text-center">
						Sejarah Jasamarga Bali Tol
					</h1>
					<p className="text-gray-500 py-5 text-base tracking-wide text-center">
						Sekilas sejarah pembangunan Tol Bali Mandara dan Kantor
						Jasamarga Bali Tol
					</p>
				...
				<div className="container mx-auto">
					<div className="flex flex-col items-center  md:flex-row md:gap-[20px] ">
								...
								<YearSejarah>
									{apiSejarah["data"].map(
										(res: any, key: number) => (
											<li
												key={key}
												className="md:flex md:flex-row  md:items-center md:py-12 md:hover:scale-102 md:hover:transition-transform md:duration-200"
											>
												<div className="text-center md:text-end">
													<Link
														...
														scroll={false}
														className="text-main text-3xl font-black "
													>
														{res.nama}
													</Link>
												</div>
						...
						<div className="w-full text-center md:text-left py-12 md:py-0">
							<div className="py-5">
								<h1 className="text-main text-6xl font-black">
									{response?.nama}
								</h1>
							</div>
							<div className="">
								<p className="text-main tracking-wide text-lg md:text-2xl whitespace-pre-line">
									{response?.deskripsi}
								</p>
							</div>
						</div>
			...
			<div className="bg-[url('/image/bg-tentangkami.png')] bg-scroll bg-position-[center_top_-15rem] bg-cover  bg-no-repeat rounded-t-[3rem]">
				<section className="py-12 container mx-auto px-5 md:px-0  ">
					<h1 className="text-main text-2xl tracking-wide text-center font-bold md:font-black py-2 ">
						Dewan Komisaris
					</h1>
					...
					<div className="grid grid-cols-2 md:flex md:justify-center gap-4 md:gap-4 ">
						{apiDireksi["data"]
							.filter((res) => res.tipe_direksi === "d_komisaris")
							.map(
								(
									res: {
										id: number;
				...
				<section className="py-12 container mx-auto px-5 md:px-0">
					...
					<div className="mx-auto text-center">
						<div className="flex justify-center  gap-4 md:gap-4">
							{apiDireksi["data"]
								.filter(
									(res) => res.tipe_direksi === "d_direksi",
								)
								.map(
									(
										res: {
				...
				<section className="container mx-auto py-12">
					<h1 className="text-main text-2xl tracking-wide text-center font-bold md:font-black py-2 text-u">
						STRUKTUR ORGANISASI
					</h1>
					<hr className="w-28 md:w-34 text-second  border-t-10 md:border-t-12 py-4 mx-auto" />
					<div className="">
			...
			<section className="py-12 container mx-auto ">
				<h1 className="text-main text-2xl tracking-wide text-center font-bold md:font-black py-8">
