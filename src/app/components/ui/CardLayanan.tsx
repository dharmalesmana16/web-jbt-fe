...
export default async function CardLayanan(props:propsLayanan) {
    ...
    return (
        ...
        <div  className="flex p-5 flex-col max-w-xl rounded-3xl hover:-translate-y-1 hover:scale-100 hover:transition hover:duration-500  h-full text-center bg-[#F4F4F4] border border-gray-200  shadow-xl dark:bg-gray-800 dark:border-gray-700">
