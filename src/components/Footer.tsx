						...
						<div className="flex w-full justify-start md:justify-end">
							<div className="px-2">
								<div className="border-2 border-main p-2 rounded-full hover:bg-second duration-100">
									<a
										href="https://www.instagram.com/jasamargabalitol_official/"
										target="_blank"
									>
							...
							<div className="px-2">
								<div className="border-2 border-main p-2 rounded-full hover:bg-second duration-100">
									<a
										href="https://www.tiktok.com/@jasamargabalitol?is_from_webapp=1&sender_device=pc"
										target="_blank"
									>
							...
							<div className="px-2">
								<div className="border-2 border-main p-2 rounded-full hover:bg-second duration-100">
									<a
										href="https://www.youtube.com/@jasamargabalitol3838"
										target="_blank"
									>
							...
							<div className="px-2">
								<div className="border-2 border-main p-2 rounded-full hover:bg-second duration-100">
									<a
										href="https://www.facebook.com/tolbalimandara17/?locale=id_ID"
										target="_blank"
									>
						...
						<div className="container">
							...
							<ul className="text-gray-500  font-medium">
								<li className="mb-4">
									<a
										target="_blank"
										href="https://maps.app.goo.gl/HqV8WC5WXZoVcuij7"
										className="group hover:text-gray-900 text-sm tracking-light "
									>
										<FaLocationDot className="text-lg inline-block group-hover:text-second duration-200" />{" "}
										(Grha Bali Tol) Jl Raya Pelabuhan Benoa
										No.88 Kota Denpasar, Bali 80222
									</a>
								</li>
								<li className="mb-4">
									<Link
								...
								<li className="mb-4">
									<Link
										...
										className="group hover:text-gray-900 text-sm tracking-light "
									>
										<MdEmail className="text-lg inline-block group-hover:text-second duration-200 group-hover:scale-105" />{" "}
										corporate@jasamargabalitol.co.id
									</Link>
								</li>
							</ul>
						</div>
