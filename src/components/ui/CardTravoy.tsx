		...
		<div>
			<div className="flex flex-col md:flex-row p-5 rounded-3xl  h-full bg-white border border-gray-200  shadow-md dark:white dark:border-white">
				<div className="md:basis-64 px-4">
					<img
						className=" mx-auto "
						src="/image/logo-travoy.png"
						alt=""
					/>
				</div>
				<div className="md:basis-128 ">
					<h5 className=" text-xl text-left font-bold md:font-black tracking-tight text-main ">
						Travoy
					</h5>
					<div className="py-2">
						<div className="border-t-2 border-b-2 border-[#F4f4f4] p-2 pl-0 flex flex-row">
							<div className="px-2">
								<button
									...
									className={
										"border-2 hover:border-second hover:text-main  rounded-3xl text-left  p-2 inline-flex items-center  text-gray-900 cursor-pointer  " +
										(type == "desc"
											? "border-main"
											: "font-normal border-main-100")
									}
								>
					...
					{type == "desc" && (
						<div className="py-2 w-full ">
							<div className="pb-3 ">
								<p className=" text-lg  dark:text-gray-600 leading-loose  font-medium text-gray-500">
									Travoy adalah aplikasi digital dari Jasa
									Marga yang dirancang untuk memudahkan
									pengguna jalan tol di Indonesia.{" "}
								</p>
							</div>
					...
					{type == "down" && (
						<div className="py-2 w-full ">
							<div className="py-2">
								<div className=" group hover:border-second  bg-gradient-to-r from-main-500 via-main-600 to-main-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-main-300 dark:focus:ring-main-800  rounded-3xl px-5 w-64 md:w-fit">
									<a
										href="https://play.google.com/store/apps/details?id=com.jm.travoy"
										target="_blank"
										className=" font-bold group-hover:text-white text-white  p-4  text-md tracking-light inline-flex items-center px-2 "
									>
